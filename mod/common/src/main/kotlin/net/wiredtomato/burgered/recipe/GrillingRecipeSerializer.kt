...
class GrillingRecipeSerializer : RecipeSerializer<GrillingRecipe> {
    private val _codec = RecordCodecBuilder.mapCodec { instance ->
        val group = instance.group(
            Codec.STRING.optionalFieldOf("group", "").forGetter(GrillingRecipe::group),
            ...
            Codec.FLOAT.fieldOf("experience").orElse(0.0F).forGetter(GrillingRecipe::experience),
            Codec.INT.fieldOf("cookingtime").orElse(100).forGetter(GrillingRecipe::cookingTime)
        )
